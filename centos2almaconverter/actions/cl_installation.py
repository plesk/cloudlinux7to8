...
class CloudLinuxLeappInstallation(action.ActiveAction):
    ...
    def _prepare_action(self) -> action.ActionResult:
        if not rpm.is_package_installed("elevate-release"):
            util.logged_check_call(["/usr/bin/yum", "install", "-y", "https://repo.cloudlinux.com/elevate/elevate-release-latest-el7.noarch.rpm"])
